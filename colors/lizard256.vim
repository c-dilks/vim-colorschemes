...
call <SID>X("Folded",		"a0a8b0",	"303070",	"none")
...
call <SID>X("WarningMsg",	"ff0000",	"",			"")
			...
			"DiffDelete
			"DiffText
call <SID>X("DiffAdd",    "", "500050", "none")
call <SID>X("DiffChange", "", "505050", "none")
call <SID>X("DiffDelete", "", "005050", "none")
call <SID>X("DiffText",   "", "700000", "none")
